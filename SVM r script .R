...
#The model did well, as it showed a low missclassification rate, which was 0.026 or .3%.
#What is the accuracy rate?
#The accuracy rate was about 97% which is a really positive outlook for the model. 
1-0.0266
